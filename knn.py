...
# 10% test 90% train accuracy: 0.96 i.e, 96%
...
print(clf.predict(dataset.data[-5].reshape(1,-1)))

plt.imshow(255-dataset.data[-5].reshape(28,28),cmap='gray')
plt.show()

joblib.dump(clf, "Knn_cls.pkl", compress=3)
